<script lang="ts">
    ...
    import Popup from '$lib/shared/ui/components/modal/Popup.svelte';
    import Content from '$lib/shared/ui/components/modal/Content.svelte';
	...
	{#if projects.length > 0}
		{#each projects as project}
            ...
            <Content on:showSurprise={showModal} />
                {#if browser}
                <Modal show={$modal} styleWindow={windowStyle} />
                {/if}
		{/each}
	{/if}
	<!-- End: Top Projects -->
